...
const Terms: Component = () => {
  ...
  return (
    <div class={styles.root}>
      ...
      <Typography variant="body1">Last updated: December 16, 2022</Typography>
      ...
      <Typography variant="body1">For the purposes of these Terms and Conditions:</Typography>
      <ul>
        <li>
          <Typography variant="body1">
        ...
        <li>
          <Typography variant="body1">
            ...
            <Link href="https://www.termsfeed.com/terms-conditions-generator/" target="_blank">
      ...
      <Typography variant="body1">Upon termination, Your right to use the Service will cease immediately.</Typography>
