    ...
    <div class={styles.root}>
      ...
      <ul>
        ...
        <li>
          ...
          <Typography variant="body1">Type: Persistent Cookies</Typography>
          <Typography variant="body1">Administered by: Us</Typography>
          <Typography variant="body1">
        ...
        <li>
          ...
          <Typography variant="body1">Type: Persistent Cookies</Typography>
          <Typography variant="body1">Administered by: Third-Parties</Typography>
          <Typography variant="body1">
      ...
      <ul>
        <li>
          ...
          <Typography variant="body1">Collected: Yes.</Typography>
        </li>
        <li>
          <Typography variant="body1">
            <strong>
        ...
        <li>
          ...
          <Typography variant="body1">Collected: No.</Typography>
        </li>
        <li>
          <Typography variant="body1">
        ...
        <li>
          ...
          <Typography variant="body1">Examples: Interaction with our Service or advertisement.</Typography>
          <Typography variant="body1">Collected: Yes.</Typography>
        </li>
        <li>
          <Typography variant="body1">
          ...
          <Typography variant="body1">Examples: Approximate physical location.</Typography>
          <Typography variant="body1">Collected: No.</Typography>
        </li>
        <li>
          <Typography variant="body1">
        ...
        <li>
          ...
          <Typography variant="body1">Examples: Current or past job history or performance evaluations.</Typography>
          <Typography variant="body1">Collected: No.</Typography>
        </li>
        <li>
          <Typography variant="body1">
      ...
      <Typography variant="body1">Under CCPA, personal information does not include:</Typography>
      <ul>
      ...
      <ul>
        <li>
          <Typography variant="body1">Category A: Identifiers</Typography>
        </li>
        <li>
          <Typography variant="body1">
            Category B: Personal information categories listed in the California Customer Records statute (Cal. Civ.
        ...
        <li>
          <Typography variant="body1">Category F: Internet or other similar network activity</Typography>
        </li>
      </ul>
      <Typography variant="body1">
      ...
      <ul>
        <li>
          <Typography variant="body1">Service Providers</Typography>
        </li>
        <li>
          <Typography variant="body1">Our affiliates</Typography>
        </li>
        <li>
          <Typography variant="body1">Our business partners</Typography>
        </li>
        <li>
          <Typography variant="body1">
      ...
      <ul>
        ...
        <li>
          <Typography variant="body1">
            ...
            <Link onClick={() => navigate('/contact')}>https://pugsllc.com/contact</Link>
          </Typography>
        </li>
      </ul>
      <Typography variant="body1">
      ...
      <Typography variant="body1">Your request to Us must:</Typography>
      <ul>
        <li>
